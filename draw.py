...
def draw_oya_decision(stage, my_card, your_card):
    ...
    cv2.putText(dst_stage, "Enemy", (my_coords_moji[0],my_coords_moji[3]-4), fontFace=cv2.FONT_HERSHEY_SIMPLEX, fontScale=0.7, color=WHITE, thickness=2, lineType=cv2.LINE_4)
    ...
    cv2.putText(dst_stage, "You", (your_coords_moji[0],your_coords_moji[3]-4), fontFace=cv2.FONT_HERSHEY_SIMPLEX, fontScale=0.7, color=WHITE, thickness=2, lineType=cv2.LINE_4)
